...
file_location = "C:\\Users\\Sachin-Gosavi\\Desktop\\FINAL_PROJECT\\Semi-Final Project\\testing\\FinalTesting\\test.xlsx"

conn = pymysql.connect(host='192.168.43.137',user='admin',password='password',db='project')
a=conn.cursor()
...
sarray=open("C:\\Users\\Sachin-Gosavi\\Desktop\\FINAL_PROJECT\\Semi-Final Project\\testing\\FinalTesting\\specs.txt").read()
...
def read(sheetread,k):
   ...
   # tname="pdinfo_f"
    ...
    a.execute("insert into test (camera,sound,battery,ram,processor) values (%s,%s,%s,%s,%s)",(result[0],result[1],result[2],result[3],result[4]))
